...
class Ventana_Principal:
    def __init__(self,master):
        ...
        self.spaceship = load_image('player1.png')
        ...
        self.button_play = Button(self.canvas, text="Play", bg="yellow", fg='black', font=("Century Gothic", 10),
    ...
    def about(self):
        ...
        self.button_about_exit.place(x=480, y= 630, width= 50, height= 30)

    def verificacion(self):
        self.label_error = Label(self.canvas, text = "Debe ingresar su nombre", font = ('Century Gothic', 8),
                                 bg = 'black', fg = "#38EB5C")
        ...
        if self.name != "":
            ...
            return self.label_error.place(x=200, y=240)
...
class Game:
    def __init__(self,name,rango):
        ...
        self.fondo1 = load_image('fondo3.png')
        self.label_fondo1 = Label(self.canvas_game, bg='black', image=self.fondo1)
        self.label_fondo1.place(x=0, y=0)

        self.label_player = Label(self.game, text = "Player:",font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
        self.label_player.place(x=5,y=5)
        self.label_name = Label(self.game, text = name ,font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
        ...
        #Player Life
        self.player_life = 3
        self.label_player_life = Label(self.game, text = self.player_life ,font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
        self.label_player_life.place(x= 350,y= 5)
        self.label_player = Label(self.game, text = "Life:" ,font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
...
class Timer:
    def __init__(self,canvas_game):
        self.label_time = Label(canvas_game, text = "Time:",font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
        self.label_time.place(x=200, y = 5)
        self.meter = 0
        self.label_meter = Label(canvas_game, text = self.meter, font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
...
class Score:
    def __init__(self,canvas_game,rango):
        self.rango = rango
        self.score = 0
        self.label_player_score= Label(canvas_game, text = "Score:" ,font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
        self.label_player_score.place(x = 340, y = 5)
        self.label_score = Label(canvas_game, text = self.score ,font =  ("Century Gothic",12), bg = 'black', fg = 'yellow')
...
class Best_Score:
    def __init__(self):
        ...
        self.button_score_exit = Button(self.canvas_score, text = "Exit",background = 'black', fg='white',
                                        command = self.exit_score).place(x=450, y= 630, width= 50, height= 30)
        self.file = open('Best_Scores.txt','r')
        self.text = self.file.read()
        print(self.file.read())
        #Scores Label
        self.label_score = Label(self.score_window, text = self.text, font= ('Century Gothic', 14), bg = 'black', fg = 'white')
        self.label_score.place(x=165,y=80)
